package java_notes.ch07.university;
...
public class Test {
	...
	public static void main(String[] args) {
		...
		student1.name = "Suayb Kiris";
		
		// Head of Software Engineering department is Ahmet Arslan 
		department1.head = professor1;
		professor1.department = department1;
		
		// Department of Introduction to Software Eng. course is Software Eng
		// Int. to Software Eng. belongs to Software Eng. department
