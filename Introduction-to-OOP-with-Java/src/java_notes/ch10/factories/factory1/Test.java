package java_notes.ch10.factories.factory1;
...
public class Test {
	...
	public static void main(String[] args) {
		...
		// e.printInfo();
		System.out.println("Maasi: " + e.calculateSalary());
		// e.work();
		
		System.out.println("***********************");
		
		Manager m = new Manager(2, "Suayb", 2, "Production", "Production");
		// m.printInfo();
		...
		Director d = new Director(1, "Elif", 1, "Management", "Management", 10000);
		// d.printInfo();
